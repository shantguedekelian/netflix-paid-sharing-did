...
**Possible anticipation/spillover effects.** Because Netflix's rollout was heavily covered in global media, countries in later waves may have already been aware of the policy — and searching about it — before their own official rollout date. This could contaminate the "control" group's baseline in the static two-wave comparison, and may partly explain why the static DiD found a large effect that the event-study did not replicate: news of Canada/Spain's rollout may have already been shaping Wave 4 countries' search behavior during the "control" period, violating the assumption that untreated units are unaffected by other units' treatment.